...
import { DashboardScreen, DevicesScreen, GamificationScreen, BiometricsScreen, FriendsScreen, LeaderboardScreen, AnalyticsScreen, NotificationsScreen, HomeScreen, NutritionScreen, FitnessScreen, CoachScreen } from '../screens/main';
  ...
  return (
    ...
    >
      <HomeStackNav.Screen 
        ...
        options={{ title: 'Twin', headerShown: false }}
      />
      <HomeStackNav.Screen 
        name="Biometrics" 
